...
//
//     final allResponse = allResponseFromJson(jsonString);

import 'dart:convert';

AllResponse allResponseFromJson(String str) =>
    AllResponse.fromJson(json.decode(str));

String allResponseToJson(AllResponse data) => json.encode(data.toJson());
...
enum OriginalLanguage { EN, FR, RU }
